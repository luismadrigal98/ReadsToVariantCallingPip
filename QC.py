...
def main():
    ...
    if args.command == "split":
        if len(args.input_dirs) != len(args.output_dirs) or len(args.input_dirs) != len(args.job_dirs):
            print("Error: Number of input directories, output directories, and job directories must match")
            sys.exit(1)
        ...
        if len(args.batch_dirs) != len(args.job_dirs):
            print("Error: Number of batch directories and job directories must match")
            sys.exit(1)
        ...
        if len(args.batch_dirs) != len(args.output_dirs) or len(args.batch_dirs) != len(args.job_dirs):
            print("Error: Number of batch directories, output directories, and job directories must match")
            sys.exit(1)
